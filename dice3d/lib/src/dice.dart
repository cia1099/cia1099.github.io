...
class _DicesState extends State<Dices> with SingleTickerProviderStateMixin {
  ...
  void random() {
    ...
    print("\x1b[43mnum = $num, num2 = $num2\x1b[0m");
  }
  ...
  Widget build(BuildContext context) {
    ...
    final zoom =
        0.5; //(simulation.x(animationController.value)).abs() / 2 + 0.5;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: ZIllustration(
          ...
          children: [
            ZPositioned(
              translate: ZVector.only(x: 75), //ZVector.only(x: 100 * zoom),
              child: ZGroup(
                children: [
                  ZPositioned(
...
class GroupTwo extends StatelessWidget {
  final Color color;
  const GroupTwo({super.key, this.color = Colors.black});
  ...
  Widget build(BuildContext context) {
    return ZGroup(
      ...
      children: [
        ZPositioned(translate: ZVector.only(y: -20), child: Dot(color: color)),
        ZPositioned(translate: ZVector.only(y: 20), child: Dot(color: color)),
      ],
    );
  }
          ...
          child: ZGroup(
            ...
            children: [
              ZPositioned(
                  ...
                  child: GroupTwo(color: const Color(0xffF23726))),
              ZPositioned(
                  translate: ZVector.only(x: -20, y: 0),
                  child: GroupTwo(color: const Color(0xffF23726))),
            ],
